...
<body>
    ...
    <form action="http://localhost/240213WEB160VAK_BE/paskaitos/php_033/validation.php" method="GET">
    ...
    <form action="http://localhost/240213WEB160VAK_BE/paskaitos/php_033/post_validation.php" method="POST">
        <label for="first_name_field">Vardas: </label>
        <input id="first_name_field" type="text" name="first_name" required>
        <br>
        <label for="city_field">Miestas: </label>
